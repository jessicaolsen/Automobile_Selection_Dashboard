...
app.layout = html.Div(children = 
    [html.H1('Car Automobile Components', syle = {'textAlign': '#503D36', 'font-size': 24}),
    html.Div([ 
        html.Div( 
            [html.H2('Drive Wheels Type: ', style = {'margin-right': '2em'})], 
            dcc.Dropdown(id = 'wheel-dropdown', options = [{'label': 'Rear Wheel Drive', 'value': 'rwd'}, 
                {'label': 'Front Wheel Drive', 'value': 'fwd'}, 
                {'label': 'Four Wheel Drive', 'value': '4wd'}], value = 'rwd')), #Drop down Menu
        html.Div([
            html.Div([], id = 'plot1'), 
            html.Div([], id = 'plot2')
